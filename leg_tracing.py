...
camera_params = [
    # 示例占位（务必用实际标定结果替换）
    {
        ...
        "K": np.array([[1.17741831e+03, 0.00000000e+00, 9.59500000e+02],
                    [0.00000000e+00, 1.18009358e+03, 5.39500000e+02],
                    [0.00000000e+00, 0.00000000e+00, 1.00000000e+00]]),
        "dist": np.array([[ 0.28725371, -0.69132378, -1.14857662e-02,  3.50552900e-03, 3.92616041e+01]]),
        # 示例外参：第二台相机绕y轴平移 200mm
        "R": np.array([[ -0.9970351, -0.06171239, 0.04596288],
                         [0.03488628, -0.89493478, -0.44483108],
                         [ 0.06858537, -0.44190872, 0.89443431]]),
        #"t": np.array([80.146, 430.1, 839.5])  # 单位：米（或与K相同尺度）
        "t": np.array([0.06864387, 0.44212436, 0.82992775])  # 单位：米（或与K相同尺度）
    },
    {
        "K": np.array([[1.19278960e+03, 0.00000000e+00, 9.59500000e+02],
                        [0.00000000e+00, 1.18743072e+03, 5.39500000e+02],
                        [0.00000000e+00, 0.00000000e+00, 1.00000000e+00]]),
        "dist": np.array([[ 0.28357869, -0.58097189,  0,  0,  0]]),
        "R": np.array([[ 0.99946929, 0.01111799, 0.03061913],
                        [-0.01876258, 0.9648577,  0.26210224],
                        [-0.02662906, -0.26253764, 0.96455424]]),
        #"t": np.array([9.5, -304.788, 937.249])
        "t": np.array([0.0095, -0.304788, 0.937249])
    }
]
